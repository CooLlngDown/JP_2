        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="big" href="PostQuyche.php">Quy
                            Chế-Quy
                            Định</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <script>
            document.getElementById('searchButton').addEventListener('click', function () {
                ...
                var url = 'PostThanhcong.php?keyword=' + encodeURIComponent(keyword) + '&date=' + encodeURIComponent(searchDate);
        ...
        <div id="section1" class="content-section mb-4" data-content="quy chế quy định">
            ...
            // Truy vấn lấy dữ liệu từ bảng quyche
            $query = "SELECT success_id, title FROM success";
            $result = $conn->query($query);

            // Kiểm tra nếu có dữ liệu trả về
            if ($result->num_rows > 0):
                ?>
                <h1 class="mb-4">1001 Cách Để Thành Công</h1>
            ...
            $query = "SELECT success_id, title, created_at FROM success WHERE 1 = 1";
                ...
                <ul class="list-group">
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="UpdateThanhcong.php?success_id=<?php echo $row['success_id']; ?>"
                                    class="btn btn-sm btn-outline-success me-2">
                                    <i class="fa-solid fa-screwdriver-wrench"></i>
                                </a>
                                <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-id="<?php echo $row['success_id']; ?>">
                ...
                <div class="modal-dialog modal-dialog-centered"> <!-- Giữ lớp này để căn giữa theo chiều dọc -->
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteForm" method="POST" action="PostThanhcong.php">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['success_id'])) {
                ...
                $deleteQuery = "DELETE FROM success WHERE success_id = ?";
                $stmt = $conn->prepare($deleteQuery);
                $stmt->bind_param("i", $success_id);

                if ($stmt->execute()) {
                    // Xóa thành công, chuyển hướng lại với thông báo
                    echo "<script>alert('Xóa thành công'); window.location.href='PostThanhcong.php';</script>";
                    exit;
                } else {
                    // Xóa thất bại
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    deleteModal.addEventListener('show.bs.modal', function (event) {
                        ...
                        var successID = button.getAttribute('data-id');
                        var inputSuccessId = deleteModal.querySelector('#success_id');
                        inputSuccessId.value = successID;
                    });
                });
            </script>
            <!-- Chat Button -->
