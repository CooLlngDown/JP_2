...
if (isset($_GET['success_id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_query = "UPDATE success SET title = ?, description = ? WHERE success_id = ?";
    ...
    $query = "SELECT title, description FROM success WHERE success_id = ?";
    ...
    <div class="container mt-4">
        <div class="content-wrapper">
            ...
            <form action="" method="POST">
                ...
                <a href="PostThanhcong.php" class="btn btn-secondary">Quay lại</a>
            </form>
        </div>
    </div>
