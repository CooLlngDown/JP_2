    ...
    <div class="container mt-4">
        ...
        <script>
            document.getElementById('searchButton').addEventListener('click', function () {
                ...
                var url = 'PostQuyche.php?keyword=' + encodeURIComponent(keyword) + '&date=' + encodeURIComponent(searchDate);
        ...
        <div id="section1" class="content-section mb-4" data-content="quy chế quy định">
            ...
            $query = "SELECT quyche_id, title FROM quyche";
            $result = $conn->query($query);

            // Kiểm tra nếu có dữ liệu trả về
            if ($result->num_rows > 0):
                ?>
                <h1 class="mb-4">Quy Chế - Quy Định</h1>
            ...
            $query = "SELECT quyche_id, title, created_at FROM quyche WHERE 1 = 1";
                ...
                <ul class="list-group">
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="UpdateQuyche.php?quyche_id=<?php echo $row['quyche_id']; ?>"
                                    class="btn btn-sm btn-outline-success me-2">
                                    <i class="fa-solid fa-screwdriver-wrench"></i>
                                </a>
                                <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" data-id="<?php echo $row['quyche_id']; ?>">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteForm" method="POST">
                                <input type="hidden" name="quyche_id" id="quyche_id" value="">
            ...
            <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['quyche_id'])) {
                $quyche_id = $_POST['quyche_id'];

                // Xử lý xóa bản ghi trong cơ sở dữ liệu
                $deleteQuery = "DELETE FROM quyche WHERE quyche_id = ?";
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    deleteModal.addEventListener('show.bs.modal', function (event) {
                        ...
                        var quycheId = button.getAttribute('data-id');
                        var inputQuycheId = deleteModal.querySelector('#quyche_id');
                        inputQuycheId.value = quycheId;
                    });
                });
            </script>
            <!-- Chat Button -->
