...
if (isset($_GET['mucluc_id'])) {
    $quyche_id = $_GET['mucluc_id'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_query = "UPDATE mucluc SET title = ?, description = ? WHERE mucluc_id = ?";
    ...
    $query = "SELECT title, description FROM mucluc WHERE mucluc_id = ?";
    ...
    <div class="container mt-4">
        <div class="content-wrapper">
            ...
            <form action="" method="POST">
                ...
                <a href="PostPhongtrao.php" class="btn btn-secondary">Quay lại</a>
            </form>
        </div>
    </div>
